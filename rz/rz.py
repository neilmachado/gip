...
reddit = praw.Reddit(client_id="iCQv3tkDf4Hvsg", #14 letter key
                     client_secret="R98mYSQDJ8rvOl2BfjOGHFakwpUPQg", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/interesting_candle60",
                     username="interesting_candle60")
