...
reddit = praw.Reddit(client_id="nWKINh2EKufGzw", #14 letter key
                     client_secret="EEOiPackW1NmGgoz0pC3eJUuNrg7PQ", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/serious-ad-4905",
                     username="serious-ad-4905")
