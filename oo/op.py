...
reddit = praw.Reddit(client_id="7wiItYpaIXCwDA", #14 letter key
                     client_secret="TnofmSsuXAfgj5R4-ZxT7WVnuZVLfg", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/OptimalExcitement1",
                     username="OptimalExcitement1")
