...
reddit = praw.Reddit(client_id="Vy9FMvUFy_a-uQ", #14 letter key
                     client_secret="pvDW0LYfUawNHaRj1VWeqbdWl6CPfg", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/Environmental_Act411",
                     username="Environmental_Act411")
