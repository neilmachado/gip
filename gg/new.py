...
reddit = praw.Reddit(client_id="mixvZgo-Kzm7RA", #14 letter key
                     client_secret="qM6sd0yYczOXYIjUUSEedbzlybQhtA", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/Glittering_Ad7525",
                     username="Glittering_Ad7525")
