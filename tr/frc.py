...
reddit = praw.Reddit(client_id="SPwr9BBMH9S9Ng", #14 letter key
                     client_secret="WSfXZJxFvGVvFx3urD3MNE4nl6LaJA", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/Traditional_Heat_778",
                     username="Traditional_Heat_778")
