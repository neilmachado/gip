...
reddit = praw.Reddit(client_id="-toTA0QGtkLXfQ", #14 letter key
                     client_secret="5evhLLwFs0UMvdXVB45iqZHgpBQlPA", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/Comfortable-Corner13",
                     username="Comfortable-Corner13")
