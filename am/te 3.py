...
reddit = praw.Reddit(client_id="okVMt7j-PlAagg", #14 letter key
                     client_secret="qmJW8s1d1UohEpR4GN8I7HIydNZJ0g", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/administrativeway420",
                     username="administrativeway420")
