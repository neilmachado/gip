...
reddit = praw.Reddit(client_id="rRuBTWV0Y50THw",
                     client_secret="Kxjs5L49EIevlwfndXFG_p22hjhjeQ",
                     password="12345678",
                     user_agent="posted by u/SilverAffectionate87",
                     username="SilverAffectionate87")
