...
reddit = praw.Reddit(client_id="23czdNCwue-DVQ", #14 letter key
                     client_secret="GzcNTj2GUKJyXq1cxxRdxte5CMXvnQ", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/Ok-Audience-8677",
                     username="Ok-Audience-8677")
