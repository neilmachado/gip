...
reddit = praw.Reddit(client_id="3GDeYTP4GjQqGQ", #14 letter key
                     client_secret="YOTHgDFzYrJnAAXpsCX2BzDWRK2ceg", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/InvestigatorMundane6",
                     username="InvestigatorMundane6")
