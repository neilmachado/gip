...
reddit = praw.Reddit(client_id="OH9e8_HZUhitjA", #14 letter key
                     client_secret="Gs3oMzVjkuzwz_LG50ciN9ds-l9Pbw", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/MentalAd4574",
                     username="MentalAd4574")
