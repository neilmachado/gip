...
reddit = praw.Reddit(client_id="DTURgjFJzCXcpQ", #14 letter key
                     client_secret="tM1eBj5ogfC6jnfE8slMtDbpmRh4vg", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/jumpy_interaction426",
                     username="jumpy_interaction426")
