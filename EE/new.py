...
reddit = praw.Reddit(client_id="V7UDjc3Go4CyKw", #14 letter key
                     client_secret="3T0exK-9s0FUQmA_LVE_bnUK7PRAkA", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/Redit_official01",
                     username="Redit_official01")
