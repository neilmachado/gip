...
reddit = praw.Reddit(client_id="x8sJkOleuOHUvw", #14 letter key
                     client_secret="Z5Tw5p5Izeo1XxMAaiqgeuyfEOo", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/john_is_back",
                     username="john_is_back")
