...
reddit = praw.Reddit(client_id="IAVCBjxsGvMniQ", #14 letter key
                     client_secret="	HKI-AdVCZTB0Ah04L6r9lkLHtzwLYQ", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/servegloomy8931",
                     username="servegloomy8931")
...
title4 = input("Enter an epic title: ") 
url4 = input("Enter a sassy link: ") 
comment4 = input ("Enter your comment : ")

title5 = input("Enter an epic title: ") 
url5 = input("Enter a sassy link: ") 
comment5 = input ("Enter your comment : ")
