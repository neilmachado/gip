...
reddit = praw.Reddit(client_id="v5ko08Z9LsGx8g", #14 letter key
                     client_secret="ur47UEruZfP6O_VMMwFrC7uYBG4xzA", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/DisplayDesigner504",
                     username="DisplayDesigner504")
