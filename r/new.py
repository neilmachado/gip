...
reddit = praw.Reddit(client_id="4fVM0KloHU8HRA", #14 letter key
                     client_secret="SCs5YQNRTTju6YRTGev0OuG3xdkdJw", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/Repulsive-Ad12",
                     username="Repulsive-Ad12")
