...
reddit = praw.Reddit(client_id="PkHAe0LxpKKXfw-DVQ", #14 letter key
                     client_secret="cRrx6ShksBujloyLZHUm8RJieVk42g", #27 letter key
                     password="12345678",
                     user_agent="testscript by u/Glittering-Musicad",
                     username="Glittering-Musicad")
